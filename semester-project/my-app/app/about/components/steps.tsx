...
function Steps() {
  return (
    ...
    <div className="flex flex-col w-fit items-center   xs:mb-20 sm:mb-20 md:mb-20">
        ...
        <Link href={"/products"}><button className="btn btn-outline btn-accent">Add Product</button></Link>
    </div>
    ...
    <div className="flex flex-col w-96 items-center xs:mb-20 sm:mb-20 md:mb-20">
        ...
        <Link href={"/"}><button className="btn btn-outline btn-accent">Start Now</button></Link>
    </div>
</>
  )
}
